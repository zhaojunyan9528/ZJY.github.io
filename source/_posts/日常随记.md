...
![vue2生命周期](/Users/zhaojunyan/Downloads/资料（含课件）/02_原理图/生命周期.png)
...
<img src="/Users/zhaojunyan/Library/Application Support/typora-user-images/image-20240121173248736.png" alt="image-20240121173248736" style="zoom:50%;" />
...
```vue
<Child :name="name" :name="getNameFn" />
getNameFn() {...}
// child.vue
...
![vuex](/Users/zhaojunyan/Downloads/资料（含课件）/02_原理图/vuex.png)
...
+ Object.prototype.toString.call()返回表示对象的字符串，不依赖于原型链，是一个可靠的类型检查方法
...
+ 创建一个空的对象{}
+ 将新建对象的原型链连接到构造函数的原型对象上(obj.__proto_ = Fn.prototype)
